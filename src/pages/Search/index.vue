        ...
        <div class="details clearfix">
          <div class="sui-navbar">
            <div class="navbar-inner filter">
              <ul class="sui-nav">
                <li :class="{ active: isOne }" @click="arrow1(arrow)">
                  <a
                    >综合<span v-show="!arrow && isOne">⬆</span
                    ><span v-show="arrow && isOne">⬇</span></a
                  >
                </li>
                <li :class="{ active: isTwo }" @click="arrow2(arrow)">
                  <a
                    >价格<span v-show="!arrow && isTwo">⬆</span
                    ><span v-show="arrow && isTwo">⬇</span></a
                  >
                </li>
              </ul>
            </div>
...
export default {
  ...
  methods: {
    ...
    //综合价格排序箭头
    arrow1(a) {
      // if (a) this.searchParams.order = "1:asc";
      // else this.searchParams.order = "1:desc";
      if (this.searchParams.order.indexOf("2") != -1)
        this.searchParams.order = "1:desc";
      else this.searchParams.order = a ? "1:asc" : "1:desc";
      this.getData();
    },
    arrow2(a) {
      ...
      else if (a) this.searchParams.order = "2:asc";
